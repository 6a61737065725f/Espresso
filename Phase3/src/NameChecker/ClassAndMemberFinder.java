...
public class ClassAndMemberFinder extends Visitor {
	...
	public Object visitConstructorDecl(ConstructorDecl cst) {
		println("ConstructorDecl: Inserting constructor '<init>' with signature \'" +
				cst.paramSignature() + "\' into method table for class '" +
				currentClass.name() + "'.");

		addMethod(currentClass, cst, "<init>", cst.paramSignature());
		return null;
	}
	...
	public Object visitMethodDecl(MethodDecl md) {
		...
		println("MethodDecl:\t Inserting method \'" + md.getname() + "\' with signature \'" +
				md.paramSignature() + "\' into method table for class \'"
				+ currentClass.name()+ "\'.");
	...
	public Object visitFieldDecl(FieldDecl fd) {
		println("FieldDecl:\t Inserting field \'"+ fd.getname() +"\' into field table of class '" +
				currentClass.name() + "'.");
